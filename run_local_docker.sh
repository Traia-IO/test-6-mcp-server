...
# Script to build and run the Test 6  MCP Server locally in Docker
...
IMAGE_NAME="test-6-mcp-server"
CONTAINER_NAME="test-6-mcp-local"
HOST_PORT=${PORT:-8000}
CONTAINER_PORT=${PORT:-8000}

echo -e "${BLUE}🚀 Building and running Test 6  MCP Server...${NC}"
echo
...
echo
echo -e "${GREEN}✅ Test 6  MCP Server is running!${NC}"
echo
